...
class Company
{
	...
	Company(String _Name, String _InvestName)
	{
		...
		UpdateAttributes();
		Analyzer.AddDataSet("HistoricalDailyStockVolume::HistoricalDailyStockChanges", HistoricalDailyStockVolume, HistoricalDailyStockChanges, 1);
		Analyzer.AddDataSet("HistoricalDailyNews::HistoricalDailyStockChanges" , CompanyNews.ObtainDailyArticleRatings(HistoricalDailyStockChanges), 1);
	}
}
